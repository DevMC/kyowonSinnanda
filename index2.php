...
<body>
	<!--PC-->
	<div id="main_all_wrap" class="device_big" style="background-color:rgba(239, 197, 64, 1)">
		<!--탑메뉴-->
			...
			<div class="container1920 position_rel">
				<div class="container960">
					<div id="top_menu">
						...
						<ul class="menu_list">
							<li class="list_01">
								<a href="index1.php"><img src="renew_img/pc/201610tab1_off.png" alt="신난다! 특장점 알아보기" class="img-responsive"></a>
							</li>
							<li class="list_02">
								<a href="index2.php"><img src="renew_img/pc/201610tab2_on.png" alt="신난다! 영상 event" class="img-responsive"></a>
							</li>
							<li class="list_03">
								<a href="index3.php"><img src="renew_img/pc/201610tab3_off.png" alt="신난다! 퍼즐 event" class="img-responsive"></a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="container-fluid " id="sub02_new">
			<div class="container1920 position_rel">
				...
				<div class="container1920 sub2_back">
					<div class="container960 text-center">
						...
						<div class="video_box">
							<div class="video_box_inner">
								<div class='embed-container'>
									<iframe src='https://www.youtube.com/embed/B-Mt38InG9Q?rel=0&wmode=opaque'  frameborder='0' allowfullscreen ></iframe>
								</div>
							</div>
						</div>
						...
						<a href="#" class="sub2_q_btn" onclick="event2_check_advtg();"><img src="renew_img/pc/q_btn_20161017.png" alt="응모하기"></a>
					</div>
				</div>
			</div>
			<!--컨텐츠 끝-->
			...
			<div class="popup" id="info_pop">
				...
				<form id="index2">
					...
					<div class="info_input_wrap">
						<label for="name"><img src="renew_img/pc/title_01_2.png" class="title01"></label>
						<input type="text" id="name" class="name" placeholder="이름을 입력해주세요">
						<label for="phone_num"><img src="renew_img/pc/title02_2.png" class="title02"></label>
					...
					<div class="agree_box1">
						...
						<label for="agree01"><img src="renew_img/pc/title_03_2.png" class="title03"></label>
						<div class="agree_01">
							<?php
							include 'agree_1.php';
							?>
					...
					<div class="agree_box2">
						...
						<label for="agree02"><img src="renew_img/pc/title_03_2.png" class="title03"></label>
						<div class="agree_02">
							<?php
							include 'agree_2.php';
							?>
			...
			<div class="popup" id="sns_share_pop">
				...
				<ul>
					<li>
						<button type="button" class="share_fb"><img src="img/fb_icon.png"></button>
					</li>
					<li>
						<button type="button" class="share_tw"><img src="img/tw_icon.png"></button>
					</li>
					<li style="margin-right:0px;">
						<button type="button" class="share_kt" ><img src="img/kt_icon.png"></button>
					</li>
				</ul>
				<div class="clearfix"></div>
	...
	<div class="container960 device_small">
		...
		<div id="content_menu">
			<ul>
				<li>
					<a href="index1.php"><img src="renew_img/mobile/201610tab1_off_mobile.png" alt="신난다! 특장점 알아보기"></a>
				</li>
				<li>
					<a href="index2.php"><img src="renew_img/mobile/201610tab2_on_mobile.png" alt="신난다! 영상 event"></a>
				</li>
				<li>
					<a href="index3.php"><img src="renew_img/mobile/201610tab3_off_mobile.png" alt="신난다! 퍼즐 event"></a>
				</li>
			</ul>
		</div>
		<div class="clearfix"></div>
			...
			<div class="inner_wrap">
				...
				<div class="position_rel vod_wrap">
				   ...
				   <div class="vod_inner_wrap">
					   <div class="vod_box">
						   <div class="embed-container"><iframe src="https://www.youtube.com/embed/B-Mt38InG9Q?rel=0&wmode=opaque" frameborder="0" allowfullscreen=""></iframe></div>
					   </div>
				   </div>
			   </div>
			</div>
	...
	<div class="popup" id="mobile_sub1_gift_pop">
		<div class="mobile_sub1_gift_inner">
			...
			<img src="renew_img/mobile/20161027mobile_sub1_gift_pop.png" class="img-responsive">
		</div>
	</div>
	<!--모바일 경품보기 팝업 끝-->
	<!--모바일 오답팝업-->
	...
	<div class="popup" id="mobile_sub2_application_pop" style="display:none;">
		<div class="mobile_sub2_application_pop_inner">
			...
			<form id="mobile_index2">
				<div class="info_input_wrap">
					<label for="mobile_index1_name"><img src="renew_img/mobile/mobile_input02_2.png" class="title01"></label>
					<input type="text" id="mobile_index1_name" class="name" placeholder="이름을 입력해주세요">
					<label for="mobile_index1_phone_num"><img src="renew_img/mobile/mobile_input01_2.png" class="title02"></label>
				...
				<div class="mobile_agree_inner">
					<div class="mobile_agree_inner_back">
						<div class="agree_box1">
							...
							<label for="mobile_index1_agree01"><img src="renew_img/mobile/mobile_input03_2.png" class="title03"></label>
							<div class="agree_01">
								<?php
								include 'agree_1.php';
								?>
						...
						<div class="agree_box2">
							...
							<label for="mobile_index1_agree02"><img src="renew_img/mobile/mobile_input03_2.png" class="title03"></label>
							<div class="agree_02">
								<?php
								include 'agree_2.php';
								?>
