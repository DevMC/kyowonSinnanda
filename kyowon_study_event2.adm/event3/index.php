...
<div class="panel panel-default" style="margin:0 auto">
    <div class="panel-heading">
        <h3 class="panel-title" style="font-weight:700"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>&nbsp;퍼즐EVENT</h3>
    </div>  
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form method="post" id="searchFrom" class="form-inline">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" name="src_regdate" value="<?=$src_regdate?>" id="datepicker" placeholder="참여날짜 ex)2016-11-01">
                  </div>
