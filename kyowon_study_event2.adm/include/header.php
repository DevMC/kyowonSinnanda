	      ...
	      <ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					<li <?if(strpos($nowurl,"event2/") == true){echo "class='active'";}?>><a href="<?=ADMDOMROOT?>/event2/" style="font-size:12px"><span class="glyphicon glyphicon-bullhorn"></span>&nbsp;EVENT(영상)</a></li>
					<li <?if(strpos($nowurl,"event3/") == true){echo "class='active'";}?>><a href="<?=ADMDOMROOT?>/event3/" style="font-size:12px"><span class="glyphicon glyphicon-bullhorn"></span>&nbsp;EVENT(퍼즐)</a></li>
				</ul>
			</li>
			<!-- <li class="dropdown">
