		...
		<div class="table-responsive">
			...
			<tbody>
				<tr style="background:#eee">
					...
					<th colspan="4" style="width:auto;text-align:center;">특.장점</th>
					<th colspan="4" style="width:auto;text-align:center;">영상 PAGE</th>
					<th colspan="4" style="width:auto;text-align:center;">퍼즐 PAGE</th>
