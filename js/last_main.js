...
function instant_prizes(val, sns){
    ...
    if( val.indexOf('바나나') != -1 ){
        ...
        //$('#instant_prizes_pop .title .title_img').attr('src','img/cel_book_title.png');
    }else if(val == "1회무료"){
        $('#instant_prizes_pop .title .title_img').attr('src','img/cel_free_title.png');
    }else if(val == "사과패드"){
        $('#instant_prizes_pop .title .title_img').attr('src','img/cel_free_title.png');
...
function instant_prizes_m(val, sns){
    ...
    if( val.indexOf('바나나') != -1 ){
        ...
        // $('#mobile_sub2_application_pop').css({'background-image':'url(img/mobile/not_celebration_back.png)'});
