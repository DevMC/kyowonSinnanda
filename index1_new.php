	...
	<body>
				...
				<div class="container1920 position_rel">
					<div class="container960">
						<div id="top_menu">
							...
							<ul class="menu_list">
								<li class="list_01"><a href="index1_new.php"><img src="renew_img/pc/201610tab1_on.png" alt="신난다! 특장점 알아보기" class="img-responsive"></a></li>
	   ...
	   <!--모바일-->
		<div class="container960 device_small">
			...
			<div id="content_menu">
				<ul>
					<li><a href="index1_new.php"><img src="renew_img/mobile/201610tab1_on_mobile.png" alt="신난다! 특장점 알아보기"></a></li>
