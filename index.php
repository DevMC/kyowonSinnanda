...
<html lang="ko">
	...
	<body>  
		<input type="hidden" value="main" class="gubunevent">
		<!--pc-->
				...
				<div class="container1920 position_rel">
					<div class="container960">
						<div id="top_menu">
							...
							<ul class="menu_list">
								<li class="list_01"><a href="index1.php"><img src="renew_img/pc/201610tab1_off.png" alt="신난다! 특장점 알아보기" class="img-responsive"></a></li>
			...
			<div class="container-fluid">
						...
						<div class="flexslider">
							  <ul class="slides">
							    ...
							    <li>							       
								    ...
								    <a href="http://blog.naver.com/sinnanda_school/220849626173" target="_blank">
                                        <img src="main_slide/img/main_thum_20161031_01.jpg" />
                                    </a>
                                    <a href="http://blog.naver.com/sinnanda_school/220849628186" target="_blank">
                                        <img src="main_slide/img/main_thum_20161031_02.jpg" />
                                    </a>
				...
				<div class="container960">
					...
					<map name="pc_main_jump_btn">
					  <area shape="rect" coords="1,1,479,117" href="index2.php" alt="영상감상 이벤트" title="영상감상 이벤트">
		...
		<div class="container960 device_small">
			...
			<div id="content_menu">
					<ul>
						<li><a href="index1.php"><img src="renew_img/mobile/201610tab1_off_mobile.png" alt="신난다! 특장점 알아보기"></a></li>
			...
			<div class="container960" id="mobile_main">
						...
						<div class="flexslider">
							  <ul class="slides">
                                ...
                                <li>                                   
                                    ...
                                    <a href="http://blog.naver.com/sinnanda_school/220849626173" target="_blank">
                                        <img src="main_slide/img/main_thum_20161031_01_mobile.jpg" class="img-responsive_50">
                                    </a> 
                                    <a href="http://blog.naver.com/sinnanda_school/220849628186" target="_blank">
                                        <img src="main_slide/img/main_thum_20161031_02_mobile.jpg" class="img-responsive_50">
                                    </a> 
                                    <a href="http://blog.naver.com/sinnanda_school/220835235070" target="_blank">
				...
				<div class="position_rel">
					<div style="overflow:hidden; width:65%; margin:0 auto; padding-bottom:5%;">
						<a href="index2.php" style="display:block; margin-top:5%; width:48%; float:left;">
