    ...
    <head>
        ...
        <body>  
            ...
            <!--탑메뉴-->
                    ...
                    <div class="container1920 position_rel">
                        <div class="container960">
                            <div id="top_menu">
                                ...
                                <ul class="menu_list">
                                    <li class="list_01"><a href="index.php"><img src="img/201609tab1_on.png" alt="메인으로 돌아가기" class="img-responsive"></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="main_more_btn">
                        <a href="javascript:open_advantage();" ><img src="img/main_more2_kyowon_off.png" alt=""></a>
                    </div> 
                    <div class="container960">
                    	<img src="img/201609btn_pc.png" style="margin-top:30px;" usemap="#pc_main_jump_btn">
						<map name="pc_main_jump_btn">
						  <area shape="rect" coords="1,1,479,117" href="index1.php" alt="영상감상 이벤트" title="영상감상 이벤트">
						  <area shape="rect" coords="478,1,956,117" href="index3.php" alt="퀴즈 이벤트" title="퀴즈 이벤트">
						</map>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div class="container960 device_small">
                ...
                <div id="content_menu">
                        <ul>
                            <li><a href="index.php"><img src="img/mobile/201609tab1_on_mobile.png" alt="메인으로 돌아가기"></a></li>
                            <li><a href="index1.php"><img src="img/mobile/201609tab2_off_mobile.png" alt="맞춤학습 event"></a></li>
                            <li><a href="index3.php"><img src="img/mobile/201609tab3_off_mobile.png" alt="퀴즈 event"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="clearfix"></div>
                <!--컨텐츠 시작-->
                <div class="container960" id="mobile_main" style="background-image:url('img/mobile/mobile_back_20160815.png');">
                    ...
                    <div class="vod_wrap" id="main_mobile_slide" style="top:24.5%">
                        <div class="vod_inner_wrap" style="width:75%; position:relative;">
                               	<div style="position:absolute; top:-5%; left:-30px; z-index:20;" id="video_comment_mobile">
					    		<img src="img/video_comment201609.png" style="width:70%;">
					    	</div>
                            <div class="flexslider">
							  <ul class="slides">
                                <!--slide01--->
                    ...
                    <div class="position_rel">
                        <div class="mobile_main_more_btn_wrap" style="padding-top:3%;">
                            <a href="javascript:open_advantage_small();" ><img src="img/mobile/mobile_main_more2_btn_off.png" class="img-responsive" alt="교원 신난다 체험스쿨 더 알아보기"></a>
                        </div>
                        <div style="overflow:hidden; width:65%; margin:0 auto; padding-bottom:5%;">
                            <a href="index1.php" style="display:block; margin-top:5%; width:48%; float:left;">
                                <img src="img/mobile/201609btn1_mobile.png" class="img-responsive">
                            </a>
                            <a href="index3.php" style="display:block; margin-top:5%; width:48%; float:right;">
                                <img src="img/mobile/201609btn2_mobile.png" class="img-responsive">
                            </a>
                        </div>
                    </div>
                    <!--당첨자 팝업-->
