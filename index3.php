				...
				<div class="container960">
					<div id="top_menu">
						...
						<ul class="menu_list">
							...
							<li class="list_02">
								<a href="index2.php"><img src="renew_img/pc/201610tab2_off.png" alt="신난다! 영상 event" class="img-responsive"></a>
							</li>
							<li class="list_03">
								<a href="index3.php"><img src="renew_img/pc/201610tab3_on.png" alt="신난다! 퍼즐 event" class="img-responsive"></a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="container1920">
						<div class="sub3_inner_back">
							...
							<div class="sub3_puzzle_wrap">
								...
								<a href="#" class="btn_application"><img src="renew_img/pc/btn_application_off.png" alt="응모하기"></a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container960 device_small">
		...
		<div id="content_menu">
			<ul>
				...
				<li>
					<a href="index2.php"><img src="renew_img/mobile/201610tab2_off_mobile.png" alt="신난다! 영상 event"></a>
				</li>
				<li>
					<a href="index3.php"><img src="renew_img/mobile/201610tab3_on_mobile.png" alt="신난다! 퍼즐 event"></a>
				</li>
			</ul>
		</div>
		<div class="clearfix"></div>
